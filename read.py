...
try:
    ...
    os.system('cls')
    print("Example: C:/Users/User/Desktop/Camera/gallery")
    directory_user_camera = input("What directory of images to use? (Folder to filter out): ")
    os.system('cls')
    print("Example: C:/Users/User/Desktop/Camera/filtered")
...
def classSchedule(a):
    a = a.removeprefix(directory_user_camera + "\\IMG")
    a = a[1:99999]
    ...
    min = int(horario[2:4])
    print("day of the week:{}  Time:{}:{}".format(day_of_week,hour, min))
